...
DATAS = ["/Volumes/bee/AI/data/en/c4-train.00000-of-01024.json"]
DATAS = glob.glob(r'/Volumes/bee/AI/data/en/*.json')
print(DATAS)
...
with concurrent.futures.ThreadPoolExecutor(max_workers=20) as executor:
    l = list(executor.map(lambda f: find_expired_domains(f), DATAS))
